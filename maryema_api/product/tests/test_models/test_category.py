...
class TestCategoryModel(TestCase):
    ...
    def test_required_division(self) -> None:
        """test required division field"""
        category = Category(name="Category 1")
        with self.assertRaises(ValidationError):
            category.save()

    def test_category_inheritance_from_BaseModel(self) -> None:
    ...
    def test_category_division_relation(self) -> None:
    ...
    def test_category_division_deletion(self) -> None:
